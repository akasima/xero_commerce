...
<section class="xe-shop list">
    <div class="container" style="padding-left:0; padding-right:0">
        <div class="search-results">
            ...
            @else
                <p class="search-results-text"><span class="search-results-text-num">{{count($products)}}</span>개의 상품이 검색 되었습니다.</p>
            @endif
        </div>
        ...
        <ul class="default-list">
            ...
            <li>
                <div class="default-list-img">
                    <a href="{{ route('xero_commerce::product.show', ['slug' => $product->getSlug()]) }}"><img src="{{$product->getThumbnailSrc()}}" alt=""></a>
                    ...
                    <ul class="default-list-sns">
                        ...
                        <li><a href="#"><i class="xi-instagram"></i><span class="xe-sr-only">인스타그램 공유</span></a></li>
                    </ul>
                </div>
                <div class="default-list-text">
                    <a href="{{ route('xero_commerce::product.show', ['slug' => $product->getSlug()]) }}"><h3 class="default-list-text-title"><span class="xe-shop-tag black">new</span><span class="xe-shop-tag">best</span> {{$product->name}}</h3>
