...
<div class="xe-shop">
    ...
    <footer class="footer">
        ...
        <div class="inner-footer">
            ...
            <small>Copyright © {{date('Y')}} {{$shopConfig['companyName']}}  All rights reserved.  <a target="_blank" href="https://www.xpressengine.io/">MADE BY XE</a></small>
        </div>
