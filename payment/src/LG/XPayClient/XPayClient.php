<?php
namespace Xpressengine\XePlugin\XeroPay\LG\XPayClient;
/**
 * @version 1.0
...
class XPayClient
{
	...
	function XPayClient($home_dir, $mode="real")
	{
		...
		define("LGD_USER_AGENT", "XPayClient (1.1.0.5/PHP)");
	...
	function init()
	{
		...
		if ($this->config["verify_host"] == 0) {
   	    ...
   	    // TLS 설정
		//; 512 (TLS1.1) , 2048 (TLS1.2) , 2560 (TLS1.0) java 버전
		...
		//echo "home_dir = " . $this->home_dir . "<br>";
