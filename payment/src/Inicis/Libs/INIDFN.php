 ...
 * @buildno			    5001
 * @date            2008.01.15
 * @note						��ü����ũ�� �߰�, DNS Lookup Timeout �߰�, DNS Lookup ���н� socket close���ϴ� �κ� �߰�
 * @date            2008.01.16
 * @note						Encrypt,Decrypt ��� ����, pkcs5 padding �߰�
 * @date            2008.01.24
 * @note						non block connect immediate return check code/str	
 * @date            2008.02.11
 * @note						key load �� read�����߻��� fclose �߰�
 * @date            2008.03.03
 ...
 * @date            2009.02.24
 * @note            1)define MKEY deprecated 2009.02.19 ( Makeshop �ʱ� �ѹ�����. ���񽺵ǰ� �ִ����� ��)
 *                  2)Makeshop PG Updrade������ ���γ��� 2009.02.19 (interface���� mkey���� �޾� ó���ϰ� ����)
 *                  3)Makeshop PG Updrade������ ���γ��� 2009.02.24 (interface���� mergelog���� �޾� ó���ϰ� ����)
 * @date            2009.05.07
...
define("TX_CANCELREASON", "CancelReason");      //2012-10-19 ��һ����ڵ� �߰�
//�������ȯ��(09.08.05)
